...
f.write("time\tmem\terror-code\tcommand\tbins\tfpr\tmax-er\tmin-len\tkmer-size\tthreads\tminimiser\tcmin\tcmax\terror-rate\trepeat-flag\tbin-entropy-cutoff\tcart-max-cap\tmax-carts\trepeat-period\trepeat-length\trepeats\tmatches\n")
f.close()
