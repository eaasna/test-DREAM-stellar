...
snakemake --snakefile Snakefile_stellar_only --configfile stellar_mouse_config.yaml --keep-going --cores 1 1> stellar_mouse.out 2> stellar_mouse.err
...
snakemake --snakefile $snakef --configfile parallelization_config.yaml --keep-going --cores 128 1> parallelization.out 2> parallelization.err
